    ...
    <div class="sidebar-wrapper active">
        ...
        <div id="sidebar">
            <div class="sidebar-wrapper active">
                    ...
                    <div class="sidebar-menu">
                        <ul class="menu">
                            ...
                            <li class="sidebar-item has-sub">
                                ...
                                <ul class="submenu">
                                    <li class="submenu-item">
                                        <a href="{{ route('laporan.tagihan') }}" class="submenu-link">
                                            Cetak Laporan</a>
                                    </li>
                                </ul>
                            </li>
                ...
                {{-- Orang Tua Sidebar --}}
                @if (session('user_role') == 'orang_tua')
                    <div class="sidebar-menu">
                        <ul class="menu">
                            <li class="sidebar-title">Menu</li>
                            ...
                            <li class="sidebar-item has-sub">
                                ...
                                <ul class="submenu">
                                    <li class="submenu-item">
                                        <a href="{{ route('pendaftaran.index') }}" class="submenu-link">Isi
                                            Pendaftaran</a>
                                    </li>
                                </ul>
                            </li>
                ...
                {{-- Bendahara Sidebar --}}
                @if (session('user_role') == 'bendahara')
                    <div class="sidebar-menu">
                        <ul class="menu">
                            <li class="sidebar-title">Menu</li>
                            ...
                            <li class="sidebar-item has-sub">
                                ...
                                <ul class="submenu">
                                    <li class="submenu-item">
                                        <a href="{{ route('kwitansi.index') }}" class="submenu-link">
                                            Lihat & Cetak Kwitansi</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="sidebar-item has-sub">
                                ...
                                <ul class="submenu">
                                    <li class="submenu-item">
                                        <a href="{{ route('laporan.rekap.index') }}" class="submenu-link">
                                            Rekap Transaksi Bulanan</a>
                                    </li>
                                </ul>
                            </li>
                ...
                @if (session('user_role') == 'kepala_sekolah')
                    <div class="sidebar-menu">
                        <ul class="menu">
                            <li class="sidebar-title">Menu</li>
